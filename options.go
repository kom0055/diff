...
// AllowPointerNilCompare determines whether nil and pointer should be compared deeply
func AllowPointerNilCompare() func(d *Differ) error {
	return func(d *Differ) error {
		d.AllowPointerNilCompare = true
		return nil
	}
}
